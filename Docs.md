...
<div style="text-align: center"><img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/cf73ec8d29894f06b0c3cd87ea818a7a~tplv-goo7wpa0wc-image.image" width="2788px" /></div>


      2. SC2.0版本在豆包声音复刻模型2.0商品里面，在这里购买的音色能同时用于tts和实时语音

<div style="text-align: center"><img src="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/df2b8790e826486ea3e44afd8372f334~tplv-goo7wpa0wc-image.image" width="2784px" /></div>
...
![alt](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_be308936e9ff0f17a6ff04c01ec40b6d.png)
...
![alt](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_2f9869686ff926e32e781d3e3047f805.png)

<span id="f1c9475e"></span>
# 2 接口说明
...
<span id="2d396ffb"></span>
### unable to decode V1 protocol message: session ID length is zeroheader二进制数据
...
|                      |                      |               | * enable_music字段用于开关唱歌能力，打开唱歌开关之后会检索曲库唱歌数据送给模型提升模型唱歌能力 | \                                               |
|                      |                      |               | * 【**必传参数**】model字段用于区分端到端模型版本，取值字段枚举：【O、SC、1.2.1.0、2.2.0.0】，默认为O | \                                               |
|                      |                      |               | * **O版本**特点支持精品音色                                  | \                                               |
|                      |                      |               | * **SC版本**特点支持声音复刻                                 | \                                               |
|                      |                      |               | * **1.2.1.0**对应O2.0版本（规范版本号）                      | \                                               |
...
| 502                  | \                    |               |                                                              |                                                 |
|                      | ChatRAGText          | \             |                                                              |                                                 |
|                      | （端到端模型O版本）  |               | 用户query之后，模型会生成闲聊结果。如果客户判断用户query不需要闲聊结果，可以输入外部RAG知识，通过模型的总结和口语化改写之后输出对应音频。外部RAG输入整体长度不超过4K个字符。 | \                                               |
|                      |                      |               |                                                              | ```JSON                                         |
|                      |                      |               |                                                              | {                                               |
|                      |                      |               |                                                              | "external_rag": {{STRING}}                      |
|                      |                      |               |                                                              | }                                               |
...
<span id="341ee1e1"></span>
# 3 快速开始
<span id="56dd513e"></span>
## Python示例

<Attachment link="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/adc49b2c833c428f9c6f6af5df3dda16~tplv-goo7wpa0wc-image.image" name="realtime_dialog.zip" ></Attachment>

<span id="791907c7"></span>
## Go示例

<Attachment link="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/82323ce4067641b582129a0eb7a299b3~tplv-goo7wpa0wc-image.image" name="realtime_dialog.zip" ></Attachment>

<span id="664484e8"></span>
## Java示例

<Attachment link="https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/ce16e31743e44e9b8eb8d28287056c82~tplv-goo7wpa0wc-image.image" name="realtime_dialog.zip" ></Attachment>
...
![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/e4cd511a8c4d4e1fadfb6fe8d2483d1a~tplv-goo7wpa0wc-image.image =1726x)

<span id="f7a89ffd"></span>
## 4.1 文本输入

![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/0bd24bf2b07f475492a51c76dad2582e~tplv-goo7wpa0wc-image.image =1566x)

<span id="822efaa2"></span>
## 4.2 合成音频
当客户判定不使用模型生成闲聊内容时，系统允许客户多次上传文本执行音频合成，以满足多样化需求。整体交互示例如下所示：

![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/59ed7a78062849a18a563f06aa625b10~tplv-goo7wpa0wc-image.image =1566x)

<span id="148eb2f2"></span>
## 4.3 外部RAG输入

![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/cad76d3ea9f242a4864a73d9b9dda027~tplv-goo7wpa0wc-image.image =1566x)

<span id="9c28718b"></span>
## 4.4 联网Agent搜索源

![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/aef00a4084a1496aa4e20e1557b6d082~tplv-goo7wpa0wc-image.image =1566x)

<span id="7e8bec59"></span>
# 5 错误码
